        ...
        for (const line of lines) {
            ...
            try {
                ...
                if (req.type === "list-models") {
                    handleListModels().then((models) => console.log(JSON.stringify({ id: req.id, ok: true, models }))).catch((e) => console.log(JSON.stringify({ id: req.id, ok: false, error: String(e) })));
                }
